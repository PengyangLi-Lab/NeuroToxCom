...
try:
    # 读取AOP缩写数据
    abbrev_path = r"C:\Users\wu'duo'duo\Desktop\AOP.xlsx"
    ...
    # 读取化合物-AOP关联数据
    compound_assoc_path = r"C:\Users\wu'duo'duo\Desktop\关联.xlsx"
    ...
    # 读取事件关联数据
    assoc_path = r"C:\Users\wu'duo'duo\Desktop\事件关联.xlsx"
